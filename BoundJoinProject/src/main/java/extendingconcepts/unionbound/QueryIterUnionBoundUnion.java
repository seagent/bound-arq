...
public class QueryIterUnionBoundUnion extends QueryIterUnion {
	protected List<Op> subOps;

	public QueryIterUnionBoundUnion(QueryIterator input, List<Op> subOps,
	...
	protected QueryIterator nextStage(Binding binding) {
		...
		for (Op subOp : subOps) {
			...
			QueryIterator parent = QueryIterSingleton.create(binding,
					getExecContext());
			QueryIterator qIter = QCUnion.execute(subOp, parent,
					getExecContext());
